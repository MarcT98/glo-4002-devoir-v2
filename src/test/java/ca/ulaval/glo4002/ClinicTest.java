...
public class ClinicTest {
    private final String ANY_NAME = "MyName";

    private final int ANY_GRAVITY = -98173;

    private final VisibleSymptom ANY_SYMPTOM = VisibleSymptom.COLD;

    private final UUID ANY_UUID = UUID.randomUUID();

    private final Patient ANY_PATIENT = new Patient(ANY_UUID, ANY_NAME, ANY_GRAVITY, ANY_SYMPTOM);
    private final Patient ANY_PATIENT_2 = new Patient(ANY_UUID, "Hello", 10, VisibleSymptom.SPRAIN);
    ...
    @Test
    public void givenClinic_whenSortingPatient_thenAddsPatientToDoctorQueue() {
        Clinic clinic = new Clinic();

        clinic.triagePatient(ANY_PATIENT);

        assertEquals(ANY_PATIENT, ANY_PATIENT_2);
    }
...
//
//    @test
//    public void giventriagepatientwithmigraine_when() {
//        clinic clinic = new clinic();
//
//        clinic.triagepatient(patient1);
//
...
//    }
    ...
    // givenTriagePatient_whenPushingPatientToFrontOfDoctorQueue_thenPatientIsInDoctorQueue()

//
//    @Test
//      @DisplayName("Given triage patient with migraine when adding patient to front of doctor queue then patientIsInDoctorQueue")
//    public void givenTriagePatientWithMigraine_whenAddingPatientToFrontOfDoctorQueue_thenPatientIsInDoctorQueue() {
//        Clinic clinic = new Clinic();
